...
# This will overwrite the ini-file sqlalchemy.url path with the path given in
# the config of the main code
config.set_main_option("sqlalchemy.url", dbc.DB_URL)
d.validate_database()
